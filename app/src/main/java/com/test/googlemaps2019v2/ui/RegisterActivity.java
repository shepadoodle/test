...
import static com.test.googlemaps2019v2.util.Check.doStringsMatch;
        ...
        switch (view.getId()){
            case R.id.btn_register:{
                ...
                if(!isEmpty(mEmail.getText().toString())
                    ...
                    Toast.makeText(RegisterActivity.this, R.string.You_must_fill_out_all_the_fields, Toast.LENGTH_SHORT).show();
                }
                break;
            }
        }
