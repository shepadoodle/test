        ...
        View.OnClickListener
{
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(LoginActivity.this, getString(R.string.userAuth) + user.getEmail(), Toast.LENGTH_SHORT).show();
    ...
    private void signIn(){
        ...
        if(!isEmpty(mEmail.getText().toString())
            ...
            Toast.makeText(LoginActivity.this, "Вы не заполнили все поля.", Toast.LENGTH_SHORT).show();
        }
    }
